...
module.exports = {
  ...
  soprofiel: {
    ...
    auth: {
      response_type: 'code',
      auth_type: 'so',
      service: process.env.SERVICE_MPROFIEL_AUTH_SERVICE || 'consentscherm.so.v1',
      client_id: process.env.SERVICE_MPROFIEL_AUTH_CLIENT_ID || 'YOUR_CLIENT_ID',
      client_secret: process.env.SERVICE_MPROFIEL_AUTH_CLIENT_SECRET || 'YOUR_CLIENT_SECRET',
      scope: 'all',
      redirect_uri: process.env.SERVICE_MPROFIEL_AUTH_REDIRECT_URI || 'http://localhost:3000/callback/soprofiel',
    },
  },
